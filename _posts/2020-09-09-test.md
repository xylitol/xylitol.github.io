...
<p align="center">
  <img src="/assets/img/paper_review/AlexNet/fig1.png" width="50%" height="50%" title="70px" alt="memoryblock">
</p>
...
# Result
<p align="center">
  <img src="/assets/img/paper_review/AlexNet/fig3.png" width="50%" height="50%" title="70px" alt="memoryblock">
</p>
ILSVRC-2010 test set에서 다른 모델들과 비교하였을 때 성능차이

<p align="center">
  <img src="/assets/img/paper_review/AlexNet/fig4.png" width="50%" height="50%" title="70px" alt="memoryblock">
</p>
ILSVRC-2012 validation과 test set에서 다른 모델과 다양한 모델을 비교하였을 때 error rate

<p align="center">
  <img src="/assets/img/paper_review/AlexNet/fig5.png" width="50%" height="50%" title="70px" alt="memoryblock">
</p>
