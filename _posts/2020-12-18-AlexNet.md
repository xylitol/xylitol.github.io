...
<p align="center">
  <img src="/assets/img/paper_review/AlexNet/fig4.png" width="40%" height="40%" title="70px" alt="memoryblock"><br>
  ILSVRC-2012 validation과 test set에서 다른 모델과 다양한 모델을 비교하였을 때 error rate 
</p>

<p align="center">
  <img src="/assets/img/paper_review/AlexNet/fig5.png" width="40%" height="40%" title="70px" alt="memoryblock"><br>
