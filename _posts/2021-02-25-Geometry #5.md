...
<br><img src="/assets/img/CV_study/5/9.png" width="40%" height="40%" title="70px" alt="memoryblock"><span style="color:red">내적을 이용하여 cos세타와 sin세타를 구하는 과정</span><br>
<br><img src="/assets/img/CV_study/5/10.png" width="40%" height="40%" title="70px" alt="memoryblock"><span style="color:red">외적으로 회전축인 법선벡터를 구하는 과정</span><br>
