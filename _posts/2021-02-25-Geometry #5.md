...
<img src="/assets/img/CV_study/5/1.png" width="100%" height="100%" title="70px" alt="memoryblock"><br>
...
<img src="/assets/img/CV_study/5/5.png" width="60%" height="60%" title="70px" alt="memoryblock"><br>

2D 변환과 마찬가지로 3D 변환에서도 homogeneous 좌표를 사용하면 다음과 같이 회전변환과 평행이동을 하나의 변환행렬로 즉, 선형변환 형태로 표현할 수 있다.<br>
<img src="/assets/img/CV_study/5/6.png" width="60%" height="60%" title="70px" alt="memoryblock"><br>
...
<img src="/assets/img/CV_study/5/7.png" width="60%" height="60%" title="70px" alt="memoryblock"><br>
<img src="/assets/img/CV_study/5/8.png" width="100%" height="100%" title="70px" alt="memoryblock"><br>
<img src="/assets/img/CV_study/5/9.png" width="60%" height="60%" title="70px" alt="memoryblock"><span style="color:red">내적을 이용하여 cos세타와 sin세타를 구하는 과정</span><br>
<img src="/assets/img/CV_study/5/10.png" width="60%" height="60%" title="70px" alt="memoryblock"><span style="color:red">외적으로 회전축인 법선벡터를 구하는 과정</span><br>
...
<img src="/assets/img/CV_study/5/12.png" width="70%" height="70%" title="70px" alt="memoryblock"><br>
