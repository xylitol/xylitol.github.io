...
<img src="/assets/img/CV_study/6/5.png" width="30%" height="30%" title="70px" alt="memoryblock"><br>

여기서 H는 3*4 행렬로서 다음과 같이 분해하여 표현할 수 있다.<br>
<img src="/assets/img/CV_study/6/6.png" width="80%" height="80%" title="70px" alt="memoryblock"><br>
...
<img src="/assets/img/CV_study/6/7.png" width="80%" height="80%" title="70px" alt="memoryblock"><span style="color:red">식(1)</span><br>
...
<img src="/assets/img/CV_study/6/8.png" width="80%" height="80%" title="70px" alt="memoryblock"><span style="color:red">식(2)</span><br>
...
<img src="/assets/img/CV_study/6/9.png" width="80%" height="80%" title="70px" alt="memoryblock"><br>
